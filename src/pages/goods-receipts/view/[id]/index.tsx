...
import { getGoodsReceiptById } from 'apiSdk/goods-receipts';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('goods_receipt', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/goods-receipts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Stack direction="column" spacing={2} mb={4}>
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.po_date as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
